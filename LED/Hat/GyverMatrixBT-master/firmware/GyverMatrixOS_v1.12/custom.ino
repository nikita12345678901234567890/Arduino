...
/*
  ...
  //Бегущая строка:
    fillString("Hello Hale", 1);    // цвет вида 0x00ff25 или CRGB::Red и проч. цвета
    fillString("Happy Halloween", 1);       // радужный перелив текста
    fillString("Trick or Treat", 2);       // каждая буква случайным цветом!
...
void customModes() {
  switch (thisMode) {
    ...
    case 0: fillString("Hello Hale", CRGB::Red);
      break;
    case 1: fillString("Happy Halloween", 1);
      break;
    case 2: fillString("Trick or Treat", 2);
      break;
    case 3: madnessNoise();
      break;
    case 4: cloudNoise();
